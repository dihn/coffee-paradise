...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CoffeeType' => function () {
    return ($this->privates['App\Form\CoffeeType'] ?? $this->privates['App\Form\CoffeeType'] = new \App\Form\CoffeeType());
...
}, 'App\\Form\\ReviewType' => function () {
    return ($this->privates['App\Form\ReviewType'] ?? $this->privates['App\Form\ReviewType'] = new \App\Form\ReviewType());
