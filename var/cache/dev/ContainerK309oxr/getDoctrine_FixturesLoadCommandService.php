...
$a->addFixtures(array(0 => new \App\DataFixtures\LoadCoffee(), 1 => new \App\DataFixtures\LoadMembers(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 2 => new \App\DataFixtures\LoadReviews()));
