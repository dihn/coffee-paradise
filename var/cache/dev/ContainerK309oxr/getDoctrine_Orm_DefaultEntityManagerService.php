...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CoffeeRepository' => function () {
    return ($this->privates['App\Repository\CoffeeRepository'] ?? $this->load('getCoffeeRepositoryService.php'));
    ...
    return ($this->privates['App\Repository\ReviewRepository'] ?? $this->load('getReviewRepositoryService.php'));
}))));
