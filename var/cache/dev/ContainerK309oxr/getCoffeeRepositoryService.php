...
// Returns the private 'App\Repository\CoffeeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CoffeeRepository.php';

return $this->privates['App\Repository\CoffeeRepository'] = new \App\Repository\CoffeeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
