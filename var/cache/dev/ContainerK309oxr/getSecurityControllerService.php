...
return $this->services['App\Controller\SecurityController'] = new \App\Controller\SecurityController(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
