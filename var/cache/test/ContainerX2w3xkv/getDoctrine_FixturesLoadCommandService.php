...
include_once $this->targetDirs[3].'\\src\\DataFixtures\\LoadCoffee.php';
include_once $this->targetDirs[3].'\\src\\DataFixtures\\LoadMembers.php';
include_once $this->targetDirs[3].'\\src\\DataFixtures\\LoadReviews.php';
...
$a->addFixtures(array(0 => new \App\DataFixtures\LoadCoffee(), 1 => new \App\DataFixtures\LoadMembers(($this->services['security.password_encoder'] ?? $this->load(__DIR__.'/getSecurity_PasswordEncoderService.php'))), 2 => new \App\DataFixtures\LoadReviews()));
