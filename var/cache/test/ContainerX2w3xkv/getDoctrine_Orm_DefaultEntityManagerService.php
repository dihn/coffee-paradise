...
$a->setNamespace('sf_orm_default_c0fbfec3c6d3d86ae54053b41dd18b0a5ef880a1e32c945cdf6ad63b1693c431');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_c0fbfec3c6d3d86ae54053b41dd18b0a5ef880a1e32c945cdf6ad63b1693c431');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_c0fbfec3c6d3d86ae54053b41dd18b0a5ef880a1e32c945cdf6ad63b1693c431');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CoffeeRepository' => function () {
    return ($this->privates['App\Repository\CoffeeRepository'] ?? $this->load(__DIR__.'/getCoffeeRepositoryService.php'));
}, 'App\\Repository\\MemberRepository' => function () {
    return ($this->privates['App\Repository\MemberRepository'] ?? $this->load(__DIR__.'/getMemberRepositoryService.php'));
